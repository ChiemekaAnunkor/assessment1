...
let pinkTons = [];
pinkAcres.forEach((Element) => pinkTons.push(Element * 6.5));
...
let pinkPounds = pinkTons.reduce((a, b) => a + b) * 2000;
...
console.log("total prices per pound $" + fujiProfit);
console.log("total prices per pound $" + galaProfit);
console.log("total prices per pound $" + pinkProfit);
// PROBLEM 7
